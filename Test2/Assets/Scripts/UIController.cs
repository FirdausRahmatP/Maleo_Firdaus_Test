...
public class UIController : Singleton<UIController>
{
    ...
    public void ShootCharacter(Vector2 move)
    {
        ...
        }else if(CameraController.Instance.currentMode == CameraController.CameraMode.ThirdPerson)
        {
            ...
            {
                CameraController.Instance.transform.Rotate(Vector3.up, move.x*0.2f, Space.World);
                CameraController.Instance.rig.Rotate(Vector3.right, -move.y * 0.2f, Space.Self);
